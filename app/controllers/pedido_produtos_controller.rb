class PedidoProdutosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pedido_produto.save
        format.html { redirect_to pedido_pedido_produtos_path(@pedido), notice: 'Pedido criado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @pedido_produto.update(pedido_produto_params)
        format.html { redirect_to pedido_pedido_produto_path(@pedido), notice: 'Pedido atualizado com sucesso.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to pedido_pedido_produto_path(@pedido), notice: 'Pedido apagado com sucesso.' }
