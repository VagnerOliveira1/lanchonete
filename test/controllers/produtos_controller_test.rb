...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { descricao: @produto.descricao, name: @produto.name, quantidade: @produto.quantidade, tipo_produto_id: @produto.tipo_produto_id } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { descricao: @produto.descricao, name: @produto.name, quantidade: @produto.quantidade, tipo_produto_id: @produto.tipo_produto_id } }
