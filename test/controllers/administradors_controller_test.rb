...
class AdministradorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrador" do
    assert_difference('Administrador.count') do
      post administradors_url, params: { administrador: { email: @administrador.email, name: @administrador.name, senha: @administrador.senha } }
    end
  ...
  test "should update administrador" do
    patch administrador_url(@administrador), params: { administrador: { email: @administrador.email, name: @administrador.name, senha: @administrador.senha } }
